...
This redesign is the successor of test infrastructure design attempt on ebpf-fw repository.(GitHub:[link](https://github.com/fatih881/ebpf-fw))  
Motivation   
...
- GitHub Actions Listener : Since we need to work on features of NIC's,GitHub Actions can not run integration tests on a virtualized enviorement.Other test types can be run on containers for keeping the enviorement clean.
